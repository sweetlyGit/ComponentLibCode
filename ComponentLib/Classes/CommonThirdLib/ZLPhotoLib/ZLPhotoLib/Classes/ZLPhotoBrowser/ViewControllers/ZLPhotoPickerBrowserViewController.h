...
typedef void(^playBlock)(NSInteger tag);
...
@property (nonatomic,copy)playBlock block; // 原图回调
//@property (weak,nonatomic) UIButton   *originalBtn;//原图按钮
@property (strong,nonatomic) NSMutableArray *titles; // titles
@property (strong,nonatomic) NSMutableArray *originalArr; // titles
